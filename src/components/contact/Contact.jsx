      ...
      <div className="container contact_container">
        <div className="contact_options">
          <article className='contact_option'>
            ...
            <h4>Email</h4>
            <h5>heyuhao97@gmail.com</h5>
            <a href='mailto:heyuhao97@gmail.com' target="_blank" rel="noreferrer">Send a message</a>
          </article>
            <article className='contact_option'>
            <FaLinkedin className='contact_option-icon'/>
            <h4>LinkedIn</h4>
            <h5>yuhaohe97</h5>
            <a href='https://www.linkedin.com/in/yuhaohe97/' target="_blank" rel="noreferrer">Send a message</a>
          </article>
          <article className='contact_option'>
            <FaAngellist className='contact_option-icon'/>
            <h4>AngelList</h4>
            <h5>yuhao-he-2</h5>
            <a href='https://wellfound.com/u/yuhao-he-2' target="_blank" rel="noreferrer">Send a message</a>
          </article>
        </div>
